...
用法:
    from research.deep_research import ResearchReport, generate_batch
...
class ResearchReport:
    ...
    def _dim_mianji_refs(self) -> dict:
        from research.knowledge_ref import get_kb
        kb = get_kb()
        # 按名称和产业链标签查询
        query_terms = [self.name, self.symbol[:3]]
        # 从链扫描获取产业链信息
        try:
            from research.chain_scanner import get_chain_for_symbol
