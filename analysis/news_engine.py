...
过去30天的政经新闻（共{len(news_items)}条）：
{items_text}

任务：生成一份「30天市场情报」，不要逐条复述标题，而是**合成分析**：

【市场情绪】
整体：[🟢偏多/🔴偏空/🟡中性] | 多空得分：[利好条数]/[利空条数]/[中性条数]
核心叙事：[用1句话概括这30天最重要的1-2个市场主题或政策转向]

【关键事件解读（选最重要的3-5条，每条50-80字分析）】
① [自拟事件标题] → 影响链：[产业链] / 方向：[↑/↓/→]
   解读：[这条新闻为什么重要？对什么资产有利/不利？市场怎么理解？]

【产业链情绪变化】（选有实质变化的链，最多5条）
[链名]：[↑升温/↓降温/→平稳] — [1句理由，引用具体事件]

【操作提示】（双门视角）
→ [基于宏观信号和新闻方向，1-2句本周操作建议]

产业链范围：GPU/AI芯片、先进制程+封装、存储/HBM、AI电力、AI网络+云计算、AI应用/Agent、网络安全/国产替代、机器人、新能源、消费电子、中国市场、地缘政治、全球宏观

严格用中文，只输出以上格式。分析要具体、犀利、可操作，不要泛泛而谈。"""
