"""
[DEPRECATED] 政经新闻抓取模块 — RSS新闻源聚合 v5.3
⚠️ 本模块已于 2026-07-08 废弃，Google RSS 在中国大陆无法访问。
   替代方案: news/fetcher.py — 东方财富 + 财联社 + 巨潮 多源实时新闻
   替代管线: news/pipeline.py — NewsPipeline 类
升级：总分结构 + 源链接 + 产业链关联分类
